...
//! `filesystems`/`hostdevs`/`serials` are modeled so far, matching how
...
//! [`super::DeviceHostdev`], [`super::DeviceSerial`]) — the remaining
...
use super::{
    ...
    DeviceNetwork, DeviceSerial, DeviceSound,
};
